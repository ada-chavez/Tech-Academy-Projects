function getReceipt() {
    ...
    //sets size total depending on what radio button is chosen
    ...
    runningTotal = sizeTotal; //sets runningTotal with price of pizza size
    console.log(selectedSize+" = $"+sizeTotal+".00"); //prints to console
